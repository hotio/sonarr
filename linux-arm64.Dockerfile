...
RUN mkdir "${APP_DIR}/bin" && \
    curl -fsSL "https://github.com/Sonarr/Sonarr/releases/download/v${VERSION}/Sonarr.${VERSION_BRANCH}.${VERSION}.linux-musl-arm64.tar.gz" | tar xzf - -C "${APP_DIR}/bin" --strip-components=1 && \
